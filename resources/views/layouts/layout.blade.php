...
<head>
    ...
    <meta name="description" itemprop="description" content="@yield('description')|今すぐに翻訳してほしい！！日英・英日翻訳の依頼者と翻訳者をマッチングさせるサイトです。翻訳してほしい文章を提出して、あとは待つだけ。外国人とのコミュニケーション、学生さん、ビジネスの現場に！For translator jobs">
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ url('/mypage') }}">マイページ <small class="icon-arrow"></small></a>
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="{{ url('/salary') }}">報酬出金申請</a></li>
                            ...
                            <div class="header-btn-action d-flex justify-content-end">
                                <div class="btn-action-wrap d-flex">
                                    <div class="jp-author item">
                                        ...
                                        @else
                                            <i class="lnr lnr-user"></i>
                                            <span class="mr-3">{{ Auth::user()->name }}</span><br>
                    ...
                    <ul class="menulist object-custom-menu">
                        ...
                        <li class="has-mega-menu"><a href="#"><span>依頼する</span></a>
                            ...
                            <ul class="object-submenu">
                                <li><a href="job-listing.html"><span>依頼する</span></a></li>
                                <li><a href="job-with-map.html"><span>依頼履歴</span></a></li>
                            </ul>
                            <!-- End Dropdown Menu -->
                        </li>
                ...
                <ul class="list-actions">
                    ...
                    <li>
                        <a href="login-register.html">
                            ...
                            <span class="text">依頼履歴</span>
                        </a>
                    </li>
                    <li>
                        <a href="login-register.html">
                            <span><i class="lnr lnr-list"></i></span>
                            <span class="text">受託一覧</span>
                        </a>
                    </li>
                    <li>
                        <a href="login-register.html">
                        ...
                        <div class="col-xl-5 col-lg-4 col-md-6">
                            ...
                            <div class="footer-widget mb-30">
                                ...
                                <div class="address">
                                    ...
                                    <span>新潟県妙高市赤倉354-8</span>
                                </div>
                                <div class="email">
                                    <i class="lnr lnr-envelope"></i>
                                    <span>honyaku_match@gmail.com</span>
                                </div>
                                <div class="phone theme-color">(+81) 080-089-8089</div>
                                <div class="footer-widget-image d-flex mt-35">
                                    <a class="mr-5" href="#"><img src="{{ asset('frontend/jetapo/assets/images/app-store/app-store-2.png') }}" alt=""></a>
                                    <a href="#"><img src="{{ asset('frontend/jetapo/assets/images/app-store/app-chplay-2.png') }}" alt=""></a>
                                </div>
                            </div>
                            <!-- Footer Widget End -->
                        </div>
