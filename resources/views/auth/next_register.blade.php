                                        ...
                                        <form action="{{ route('register') }}" method="post">
                                            ...
                                            <div class="row row-5 d-flex navbar-nav">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="single-input">
                                                        @if ($errors->has('phone'))
                                                            <input type="phone" class="form-control is-invalid" placeholder="電話番号" name="phone" value="{{ old('phone') }}" required autofocus>
                                                            
                                                            <span class="error invalid-feedback" role="alert">
                                                                <strong>{{ $errors->first('phone') }}</strong>
                                                            </span>
                                                        @else
                                                            <input type="phone" class="form-control" placeholder="電話番号" name="phone" value="{{ old('phone') }}" required autofocus>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="single-input">
                                                        @if ($errors->has('phone'))
                                                            <input type="country" class="form-control is-invalid" placeholder="国籍" name="country" value="{{ old('country') }}" required autofocus>
                                                            
                                                            <span class="error invalid-feedback" role="alert">
                                                                <strong>{{ $errors->first('country') }}</strong>
                                                            </span>
                                                        @else
                                                            <input type="country" class="form-control" placeholder="国籍" name="country" value="{{ old('country') }}" required autofocus>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
